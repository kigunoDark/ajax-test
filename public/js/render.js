...
async function Render(type) {
    ...
    raitingSort.addEventListener('click', () => {
        finishdata = '';
       data = data.sort((a,b)=> seller[b.relationships.seller].rating - seller[a.relationships.seller].rating);
    ...
    // console.log('dataa of sallers')
    // for(let i = 0; i < seller.length; i++)
    // {
    //     console.log(seller[i].id);
    // }

    // console.log('My arr')
    // for(let i = 0; i < arr.length; i++)
    // {
    //     console.log(arr[i].relationships.seller);
    // }
